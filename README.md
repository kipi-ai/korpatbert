...
사용신청서 내용은 [한국특허정보원 언어모델 사용신청서(한글)](./docs/한국특허정보원 언어모델 사용신청서_한글.hwp), [한국특허정보원 언어모델 사용신청서(워드)](./docs/한국특허정보원 언어모델 사용신청서_워드.docx) 파일에서 확인하실 수 있습니다.


### 4-3. 협약서
모델 및 코드를 사용할 경우 협약서 내용을 준수해주세요. 
협약서 내용은 [한국특허정보원 언어모델 KorPatBERT 사용협약서.pdf](./docs/한국특허정보원 언어모델 KorPatBERT 사용협약서.pdf) 파일에서 확인하실 수 있습니다.
