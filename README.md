...
<br>[언론보도](http://www.aitimes.kr/news/articleView.html?idxno=23637)</br>
## 
...
### 4-3. 협약서
모델 및 코드를 사용할 경우 협약서 내용을 준수해주세요. 협약서 내용은 [AGREEMENT](./docs/AGREEMENT_corp.png)파일에서 확인하실 수 있습니다.
