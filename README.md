...
### 4-2. 사용신청서
모델 및 코드를 사용하고자 하시면 [사용신청서](./docs/언어모델_KorPatBERT_사용신청서.xlsx)를 작성하여 제출해주세요.
사용신청서 내용은 APPLICATION 파일에서 확인하실 수 있습니다.


### 4-3. 협약서
모델 및 코드를 사용할 경우 협약서 내용을 준수해주세요. 
협약서 내용은 AGREEMENT 파일에서 확인하실 수 있습니다.


### 4-4. 라이선스
모델 및 코드를 사용할 경우 라이선스 내용을 준수해주세요. 
특히 상업적 활용을을 위해서는 사전협의가 필요합니다.
라이선스 내용은 LICENSE 파일에서 확인하실 수 있습니다.
