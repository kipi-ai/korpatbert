...
### 4-2. 사용신청 절차
1. 언어모델 사용신청서([한글ver(1)](./docs/한국특허정보원_언어모델_사용신청서_한글.hwp), [워드ver(2)](./docs/한국특허정보원_언어모델_사용신청서_워드.hwp)) 및 [협약서](./docs/한국특허정보원_언어모델_KorPatBERT_사용협약서.pdf) 서식을 내려 받아 원하는 모델을 선택하여(동시 선택 가능) 소속정보를 포함해 작성합니다.
...
### 4-4. 관련 서식
 ...
 - [KorPatBERT 사용협약서(3)](./docs/한국특허정보원_언어모델_KorPatBERT_사용협약서.pdf)
