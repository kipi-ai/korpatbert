...
사용신청서 내용은 docs/[1.한국특허정보원 언어모델 사용신청서_양식(Hwp).hwp](./docs/1.한국특허정보원 언어모델 사용신청서_양식(Hwp).hwp), docs/[2.한국특허정보원 언어모델 사용신청서_양식(Word).docx](./docs/2.한국특허정보원 언어모델 사용신청서_양식(Word).docx) 파일에서 확인하실 수 있습니다.


### 4-3. 협약서
모델 및 코드를 사용할 경우 협약서 내용을 준수해주세요. 
협약서 내용은 [3.한국특허정보원 언어모델 KorPatBERT 사용협약서.pdf](./docs/3.한국특허정보원 언어모델 KorPatBERT 사용협약서.pdf) 파일에서 확인하실 수 있습니다.


### 4-4. 라이선스
모델 및 코드를 사용할 경우 라이선스 내용을 준수해주세요. 특히 상업적 활용을을 위해서는 사전협의가 필요합니다. 라이선스 내용은 [5.한국특허정보원 언어모델 상업용 라이선스 안내.pdf](./docs/5.한국특허정보원 언어모델 상업용 라이선스 안내.pdf) 파일에서 확인하실 수 있습니다.
